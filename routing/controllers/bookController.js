...
exports.makeBookPaymentController = async (req, res) => {
    ...
    const {
        _id, title, author, noOfPages, imageUrl, price, discountPrice, abstract,
        publisher, language, isbn, category, uploadImg, userMail
    } = req.body;
    const email = req.payload
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            success_url: 'https://book-store-mern-project-nine.vercel.app/payment-success',
            cancel_url: 'https://book-store-mern-project-nine.vercel.app/payment-error'
        });
        console.log(session);
